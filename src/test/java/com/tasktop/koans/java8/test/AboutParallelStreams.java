...
public class AboutParallelStreams {
	...
	public void java8_parallelFindMax() {
		...
		int max = data.parallelStream().max(Comparator.comparing(Integer::intValue)).get().intValue(); // FIXME: take a look at Collection.parallelStream and use it's max method
